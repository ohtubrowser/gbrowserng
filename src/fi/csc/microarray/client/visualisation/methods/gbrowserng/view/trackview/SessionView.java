...
public class SessionView extends GenosideComponent {
	...
	private final GenoButton quitButton = new GenoButton(this, "QUIT_BUTTON", 1.0f, 1.0f, -0.04f, -0.04f, GenoTexID.TextureID.QUIT_BUTTON);
	private final GenoButton shrinkButton = new GenoButton(this, "SHRINK_BUTTON", 1.0f, 1.0f, -0.08f, -0.04f, GenoTexID.TextureID.SHRINK_BUTTON);
	private final GenoButton openReadFileButton = new GenoButton(this, "OPENREADFILE_BUTTON", 1.0f, 1.0f, -0.12f, -0.04f, GenoTexID.TextureID.OPENFILE_BUTTON);
	private final GenoButton openAnotherSessionButton = new GenoButton(this, "ANOTHERSESSION_BUTTON", 1.0f, 1.0f, -0.16f, -0.04f, GenoTexID.TextureID.OPENFILE_BUTTON);
